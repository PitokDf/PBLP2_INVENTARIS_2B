...
class DosenController extends Controller
{
    ...
    public function update(Request $request, string $id)
    {
        ...
        $rules = [
            ...
            'dir_foto' => 'nullable|image|mimes:jpeg,png,jpeg|max:2048' // rule untuk foto boleh tidak diisi, file harus bertype gambar, ekstensi gambar yang diizinkan 'jpg, png, dan jpeg', ukuran maksimal gambar '2MB'
        ];
