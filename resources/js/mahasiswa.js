...
$(document).ready(function () {
    ...
    $('#btnCreate').click(function () {
        ...
        showModal(modal, "Add Data Mahasiswa", "btnCreateform", "<i class='fas fa-save'></i> Simpan");
    });
    ...
    $(document).on('click', '.btnEdit', function () {
        clearErrorMsg();
        showModal("modal", "Edit Data Mahasiswa", "btnEditForm", "<i class='fas fa-regular fa-pen'></i> Update");
    ...
    $(document).on('click', '.btnDetail', function () {
        showModal("modalDetail", "Detail Mahasiswa", "", "");
        var url = "mahasiswa/" + $(this).attr('id') + "/edit";
        $.ajax({
            type: "GET",
            url: url,
