...
export function calculateDenda(tglBatasPengembalian, tglDikembalikan, dendaPerHari) {
...
export function dateCutomFormat(date) {
...
export function AjaxGetData(url, callback) {
    $.ajax({
        type: "GET",
        url: url,
        dataType: "json",
...
export function AjaxGetIncludeData(url, data, callback) {
    $.ajax({
        type: "GET",
        url: url,
        data: data,
...
export function AjaxPostIncludeData(url, data, callback) {
    $.ajax({
        type: "POST",
        url: url,
        data: data,
...
export function AjaxGetIncludeSerialize(url, data, callback) {
    $.ajax({
        type: "GET",
        url: url,
        data: data,
...
export function AjaxPostIncludeSerialize(url, data, callback) {
    $.ajax({
        type: "POST",
        url: url,
        data: data,
